...
<template>
  <div class="flex h-screen flex-col justify-between border-e bg-white">
    <div class="px-4 py-6">
      <span class="grid h-10 w-32 place-content-center rounded-lg bg-gray-100 text-xs text-gray-600"> Logo </span>
    ...
    <div class="sticky inset-x-0 bottom-0 border-t border-gray-100">
      <a href="#" class="flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
        ...
        <div>
          <p class="text-xs">
            <strong class="block font-medium">Loi Tran</strong>
            <span> loi@ltran.net </span>
          </p>
        </div>
      </a>
    </div>
