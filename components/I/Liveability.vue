        ...
        <div class="flex items-center py-3">
          ...
          <div class="space-y-3 flex-1">
            <div class="flex items-center">
              ...
              <span class="px-2 py-1 rounded-lg bg-red-50 text-red-500 text-xs"> 6.2 / 10 </span>
            </div>
        ...
        <div class="flex items-center py-3">
          ...
          <div class="space-y-3 flex-1">
            <div class="flex items-center">
              ...
              <span class="px-2 py-1 rounded-lg bg-red-50 text-red-500 text-xs"> 6.8 / 10 </span>
            </div>
            <div class="overflow-hidden bg-blue-50 h-1.5 rounded-full w-full">
              <span class="h-full bg-blue-500 w-full block rounded-full" style="width: 68%"></span>
            </div>
          </div>
        </div>
        <div class="flex items-center py-3 border-t border-gray-100">
          ...
          <div class="space-y-3 flex-1">
            <div class="flex items-center">
              ...
              <span class="px-2 py-1 rounded-lg bg-green-50 text-green-700 text-xs"> 7.3 / 10 </span>
            </div>
            <div class="overflow-hidden bg-blue-50 h-1.5 rounded-full w-full">
              <span class="h-full bg-blue-500 w-full block rounded-full" style="width: 73%"></span>
            </div>
          </div>
        </div>
        <div class="flex items-center py-3 border-t border-gray-100">
          ...
          <div class="space-y-3 flex-1">
            <div class="flex items-center">
              ...
              <span class="px-2 py-1 rounded-lg bg-red-50 text-red-500 text-xs"> 6.4 / 10 </span>
            </div>
            <div class="overflow-hidden bg-blue-50 h-1.5 rounded-full w-full">
              <span class="h-full bg-blue-500 w-full block rounded-full" style="width: 64%"></span>
            </div>
          </div>
        </div>
        <div class="flex items-center py-3 border-t border-gray-100">
          ...
          <div class="space-y-3 flex-1">
            <div class="flex items-center">
              ...
              <span class="px-2 py-1 rounded-lg bg-green-50 text-green-700 text-xs"> 8 / 10 </span>
            </div>
            <div class="overflow-hidden bg-blue-50 h-1.5 rounded-full w-full">
              <span class="h-full bg-blue-500 w-full block rounded-full" style="width: 80%"></span>
            </div>
          </div>
        </div>
        <div class="flex items-center py-3 border-t border-gray-100">
          ...
          <div class="space-y-3 flex-1">
            <div class="flex items-center">
              ...
              <span class="px-2 py-1 rounded-lg bg-green-50 text-green-700 text-xs"> 8.7 / 10 </span>
            </div>
            <div class="overflow-hidden bg-blue-50 h-1.5 rounded-full w-full">
              <span class="h-full bg-blue-500 w-full block rounded-full" style="width: 87%"></span>
            </div>
          </div>
        </div>
      </section>
      <footer class="border-t border-gray-100 pt-4">
        <p class="text-sm text-gray-500 text-center">Powered by <span class="font-bold">TailwindCSS</span></p>
      </footer>
    </section>
  </div>
</template>
