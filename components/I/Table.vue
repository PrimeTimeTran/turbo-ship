...
const items = [
  {
    ...
    aboutSubtitle: 'Brings all your news into one place',
    licenseUse: 'w-2/3',
  },
  {
    name: 'Circooles',
    ...
    aboutSubtitle: 'Super lightweight design app',
    licenseUse: 'w-2/5',
  },
  {
    name: 'Sisyphus',
    ...
    aboutSubtitle: 'Time tracking, invoicing and expenses',
    licenseUse: 'w-11/12',
  },
  {
    name: 'Hourglass',
    ...
    aboutSubtitle: 'Time management and productivity',
    licenseUse: 'w-1/3',
  },
  {
    name: 'Quotient',
    ...
    statusColor: 'text-emerald-500',
    about: 'Sales CRM',
    aboutSubtitle: 'Web-based sales doc management',
    licenseUse: 'w-1/6',
  },
]
</script>
                ...
                <tr v-for="item of items">
                  <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                    <div>
                      ...
                      <p class="text-sm font-normal text-gray-600 dark:text-gray-400">{{ item.subtitle }}</p>
                    </div>
                  </td>
                  <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                    <div
                      class="inline px-3 py-1 text-sm font-normal rounded-full gap-x-2 dark:bg-gray-800"
                      :class="{ 'text-emerald-500 bg-emerald-100/60': item.status === 'Customer' }"
                    >
                      {{ item.status }}
                    </div>
                  </td>
                  <td class="px-4 py-4 text-sm whitespace-nowrap">
                    <div>
                      <h4 class="text-gray-700 dark:text-gray-200">{{ item.about }}</h4>
                      <p class="text-gray-500 dark:text-gray-400">{{ item.aboutSubtitle }}</p>
                    </div>
                  </td>
                  <td class="px-4 py-4 text-sm whitespace-nowrap">
                  ...
                  <td class="px-4 py-4 text-sm whitespace-nowrap">
                    <div class="w-48 h-1.5 bg-blue-200 overflow-hidden rounded-full">
                      <div class="bg-blue-500 h-1.5" :class="{ [`${item.licenseUse}`]: true }"></div>
                    </div>
                  </td>
