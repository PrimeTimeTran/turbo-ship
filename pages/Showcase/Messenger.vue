  ...
  return {
    users: [
      ...
      },
      {
        ...
        show: false,
        image:
          'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=60&raw_url=true&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dXNlcnN8ZW58MHwyfDB8fA%3D%3D&auto=format&fit=crop&w=500',
      },
      {
        id: 3,
        name: 'Leonard Leach ',
        ...
        show: true,
        image:
          'https://images.unsplash.com/photo-1584999734482-0361aecad844?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=60&raw_url=true&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fHVzZXJzfGVufDB8MnwwfHw%3D&auto=format&fit=crop&w=500',
      },
    ],
  }
}
        ...
        <div class="w-1/2 relative focus-within:shadow-lg" x-data="{ search : false }">
          ...
          >
            ...
            <template x-for="user in users" :key="user.id">
              <div class="w-full px-4 py-3 border-b last:border-b-0 flex items-start hover:bg-slate-50 cursor-pointer">
      ...
      <div class="h-full flex">
        ...
        <div class="h-full w-96 bg-slate-50 border-r flex flex-col">
          ...
          <div class="h-full">
            <div class="px-5 py-4 flex items-center cursor-pointer border-l-4 border-l-transparent hover:bg-slate-100">
              ...
              />
              <div class="ml-4">
                <p x-text="user.name" class="text-md font-semibold text-slate-600 m-0 p-0">Yaroslav Zubkp</p>
            ...
            <div class="px-5 py-4 flex items-center cursor-pointer border-l-4 border-l-transparent hover:bg-slate-100">
              ...
              />
              <div class="ml-4">
                <p x-text="user.name" class="text-md font-semibold text-slate-600 m-0 p-0">Alison Alison</p>
            ...
            <div class="px-5 py-4 flex items-center cursor-pointer border-l-4 border-l-transparent hover:bg-slate-100">
              ...
              <div class="ml-4">
                ...
                <p class="text-xs text-slate-400 -mt-0.5 font-semibold" x-text="user.email">We own hidden lake..</p>
              </div>
            </div>
        ...
        <div class="w-full h-full flex flex-col">
          ...
          <div class="h-full px-10 py-4">
              ...
              <div class="w-1/2">
                <div class="flex items-center">
                  ...
                  <p class="font-semibold ml-3 text-sm text-slate-600">
                    Mircel Jones <span class="text-slate-400 text-xs">3:21 PM</span>
                  </p>
                </div>
                ...
                <div class="mt-3 w-full bg-slate-50 p-4 rounded-b-xl rounded-tr-xl">
                  <p class="text-sm text-slate-500">
                    ...
                    some form , by injected humor, or randomise words which don't look even slightly believable.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="text-center my-5">
              <hr class="-mb-3" />
              <span class="text-xs text-slate-300 font-medium bg-white px-3 -mt-3">Today, 2:15 AM 5</span>
            </div>
            <!-- messages -->
