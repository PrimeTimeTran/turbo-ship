        ...
        <div class="h-screen pt-2 pb-24 pl-2 pr-2 overflow-auto md:pt-0 md:pr-0 md:pl-0">
          <div class="flex flex-col flex-wrap sm:flex-row">
              ...
              <div class="mb-4">
                <div class="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                  <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                      ...
                      <div class="flex flex-col">
                        <span class="ml-2 font-bold text-black text-md dark:text-white"> Google </span>
                        <span class="ml-2 text-sm text-gray-500 dark:text-white"> Google Inc. </span>
                      </div>
                    </div>
                    <div class="flex items-center">
                  ...
                  <div class="flex items-center justify-between mb-4 space-x-12">
                    <span
                      class="flex items-center px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-200 rounded-md"
                    >
                      PROGRESS
                    </span>
                    <span
                  ...
                  <div class="block m-auto">
                    <div>
                      <span class="inline-block text-sm text-gray-500 dark:text-gray-100">
                        Task done :
                        <span class="font-bold text-gray-700 dark:text-white"> 25 </span>
                        /50
                      </span>
                    </div>
                  ...
                  <div class="flex items-center justify-start my-4 space-x-4">
                    ...
                    <span
                      class="flex items-center px-2 py-1 text-xs font-semibold text-blue-500 bg-blue-100 rounded-md"
                    >
                      UI/UX
                    </span>
                  </div>
                ...
                <div class="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                  <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                      ...
                      <div class="flex flex-col">
                        <span class="ml-2 font-bold text-black text-md dark:text-white"> Slack </span>
                        <span class="ml-2 text-sm text-gray-500 dark:text-white"> Slack corporation </span>
                      </div>
                    </div>
                    <div class="flex items-center">
                      <button class="p-1 border border-gray-200 rounded-full">
                  ...
                  <div class="block m-auto">
                    <div>
                      <span class="inline-block text-sm text-gray-500 dark:text-gray-100">
                        Task done :
                        <span class="font-bold text-gray-700 dark:text-white"> 50 </span>
                        /50
                      </span>
                    </div>
                    <div class="w-full h-2 mt-2 bg-gray-200 rounded-full">
              ...
              <div class="mx-0 mb-4 sm:ml-4 xl:mr-4">
                <div class="w-full bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                  <p class="p-4 font-bold text-black text-md dark:text-white">
                    My Tasks
                    <span class="ml-2 text-sm text-gray-500 dark:text-gray-300 dark:text-white"> (05) </span>
                  </p>
                  <ul>
                    <li
              ...
              <div class="mb-4 sm:ml-4 xl:mr-4">
                <div class="w-full bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                  <div class="flex items-center justify-between p-4">
                    <p class="font-bold text-black text-md dark:text-white">Google</p>
                  ...
                  >
                    ...
                    <div class="flex items-center">
                      <span class="ml-2 mr-2 text-xs font-bold dark:text-gray-200 md:ml-4"> 25 min 20s </span>
                  ...
                  <div class="flex items-center justify-between p-4 border-b-2 border-gray-100">
                    <p class="font-bold text-black text-md dark:text-white">Slack</p>
                    <button class="p-1 mr-4 text-sm text-gray-400 border border-gray-400 rounded">
                      <svg width="15" height="15" fill="currentColor" viewBox="0 0 20 20">
                        <g fill="none">
                          <path
                  ...
                  <div class="flex items-center justify-between px-4 py-2 text-gray-600 border-b-2 border-gray-100">
                    ...
                    <div class="flex items-center">
                      <span class="ml-2 mr-2 text-xs text-gray-400 md:ml-4"> 30 min </span>
                      <button class="p-1 mr-4 text-sm text-gray-400 border border-gray-400 rounded">
                        <svg width="15" height="15" fill="currentColor" viewBox="0 0 20 20">
                          <g fill="none">
                            <path
            ...
            <div class="w-full sm:w-1/2 xl:w-1/3">
                  ...
                  <div class="flex flex-wrap overflow-hidden">
                    <div class="w-full rounded shadow-sm">
                      <div class="flex items-center justify-between mb-4">
                        <div class="text-xl font-bold text-left text-black dark:text-white">Dec 2021</div>
                      ...
                      <div class="-mx-2">
                        <table class="w-full dark:text-white">
                          ...
                          <tr class="text-gray-400 dark:text-gray-500">
                            <td class="px-2 py-3 text-center text-gray-300 md:px-3 dark:text-gray-500">25</td>
                            <td class="px-2 py-3 text-center text-gray-300 md:px-3 dark:text-gray-500">26</td>
                            <td class="px-2 py-3 text-center text-gray-300 md:px-3 dark:text-gray-500">27</td>
                            <td class="px-2 py-3 text-center text-gray-300 md:px-3 dark:text-gray-500">28</td>
                            <td class="px-2 py-3 text-center text-gray-300 md:px-3 dark:text-gray-500">29</td>
                            <td class="px-2 py-3 text-center text-gray-300 md:px-3 dark:text-gray-500">30</td>
                            <td class="px-2 py-3 text-center text-gray-800 cursor-pointer md:px-3 hover:text-blue-500">
                              1
                            </td>
                          </tr>
                          <tr>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">2</td>
                            ...
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">4</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">5</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">6</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">7</td>
                            <td
                          ...
                          <tr>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">9</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">10</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">11</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">12</td>
                            <td class="px-2 py-3 text-center text-white cursor-pointer md:px-3">
                              <span class="p-2 bg-blue-500 rounded-full"> 13 </span>
                            </td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">14</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">15</td>
                          </tr>
                          <tr>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">16</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">17</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">18</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">19</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">20</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">21</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">22</td>
                          </tr>
                          <tr>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">23</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">24</td>
                            ...
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">26</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">27</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">28</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">29</td>
                          </tr>
                          <tr>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">30</td>
                            <td class="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">31</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
              ...
              <div class="mb-4">
                <div class="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                  <p class="font-bold text-black text-md dark:text-white">Messages</p>
                  <ul>
                    <li class="flex items-center my-6 space-x-2">
                      ...
                      <div class="flex flex-col">
                        <span class="ml-2 text-sm font-semibold text-gray-900 dark:text-white"> Charlie Rabiller </span>
                    ...
                    <li class="flex items-center my-6 space-x-2">
                      ...
                      <div class="flex flex-col">
                        <span class="ml-2 text-sm font-semibold text-gray-900 dark:text-white"> Marie Lou </span>
                        <span class="ml-2 text-sm text-gray-400 dark:text-gray-300">
                    ...
                    <li class="flex items-center my-6 space-x-2">
                      ...
                      <div class="flex flex-col">
                        <span class="ml-2 text-sm font-semibold text-gray-900 dark:text-white"> Ivan Buck </span>
                        <span class="ml-2 text-sm text-gray-400 dark:text-gray-300">
                    ...
                    <li class="flex items-center my-6 space-x-2">
                      ...
                      <div class="flex flex-col">
                        <span class="ml-2 text-sm font-semibold text-gray-900 dark:text-white"> Marina Farga </span>
                        <span class="ml-2 text-sm text-gray-400 dark:text-gray-300"> Do you need that design ? </span>
                      </div>
                    </li>
                  </ul>
                </div>
