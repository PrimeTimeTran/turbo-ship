  ...
  <div class="flex flex-col min-w-full max-h-full overflow-y-none overflow-y-hidden">
    <div class="relative flex flex-col">
      ...
      >
        <div class="flex">
          <div class="mr-16">
            <div @click="toggleSearch" class="flex p-4 opacity-75 hover:opacity-100">
              <p class="mr-3 text-md">Foo</p>
              <div>
                <FontAwesomeIcon
                  class="text-gray-400 mr-2"
                  v-bind:icon="searching ? 'fa-solid fa-circle-xmark' : 'fa-solid fa-magnifying-glass'"
                />
              </div>
            </div>
          </div>
    ...
    >
      <AdminFoosTable :searching="searching" />
    </div>
    <div
