...
<template>
  <div class="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-600 shadow-md">
    <table class="w-full border-collapse dark:text-white text-left text-sm text-gray-500 dark:bg-slate-950">
      <thead class="bg-gray-200 dark:bg-neutral-950">
        <tr class="dark:text-black">
          ...
          <th scope="col" @click="toggleSort('lastName')" class="py-4 font-medium text-gray-500 dark:text-gray-600">
            Last Name <span v-text="getSortingIcon('lastName')" />
          </th>
          <th scope="col" @click="toggleSort('house')" class="px-6 py-4 font-medium text-gray-500 dark:text-gray-600">
            House <span v-text="getSortingIcon('house')" />
          </th>
          <th scope="col" class="px-6 py-4 font-medium text-gray-500 dark:text-gray-600">State</th>
          ...
          <th scope="col" class="px-6 py-4 font-medium text-gray-500 dark:text-gray-600">Team</th>
          <th scope="col" @click="toggleSort('charms')" class="px-2 py-4 font-medium text-gray-500 dark:text-gray-600">
            Charms <span v-text="getSortingIcon('charms')" />
          </th>
          <th scope="col" @click="toggleSort('potions')" class="px-2 py-4 font-medium text-gray-500 dark:text-gray-600">
            Potions <span v-text="getSortingIcon('potions')" />
          </th>
          <th scope="col" @click="toggleSort('DADA')" class="px-2 py-4 font-medium text-gray-500 dark:text-gray-600">
      ...
      <tbody class="w-full divide-y divide-gray-300 border-t border-gray-300 dark:divide-gray-800 dark:border-gray-600">
        <tr
          :key="wizard._id"
