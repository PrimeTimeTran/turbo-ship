...
onMounted(async () => {
    ...
    datasets: [
      {
        ...
        data: [300, 50, 100],
        backgroundColor: ['rgb(133, 105, 241)', 'rgb(164, 101, 241)', 'rgba(102, 126, 234, 1)'],
        hoverOffset: 4,
      },
    ],
  }
  ...
  const chart = await new Chart(document.getElementById('anotherChartButDoughnut'), options)
})
</script>
...
<template>
  <div class="flex flex-1 flex-col justify-between min-h-full shadow-xl p-4 rounded-lg bg-white dark:bg-neutral-900">
    ...
    <canvas id="anotherChartButDoughnut" />
  </div>
</template>
