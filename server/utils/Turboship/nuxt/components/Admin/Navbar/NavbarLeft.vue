<template>
  <div
    class="flex flex-start flex-grow sm:justify-center md:justify-start space-x-5 m-auto w-full border-b-2 sm:border-b-cyan-300 md:border-b-0"
  >
    <NuxtLink
      :to="item.url"
      :key="item.name"
    ...
    >
      <font-awesome-icon class="m-3" :icon="item.icon" />
