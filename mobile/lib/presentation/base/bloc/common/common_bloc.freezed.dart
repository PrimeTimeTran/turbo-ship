...
class _$ExceptionEmittedImpl
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ExceptionEmitted'))
...
class _$CommonStateImpl with DiagnosticableTreeMixin implements _CommonState {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CommonState(appExceptionWrapper: $appExceptionWrapper, isLoading: $isLoading, loadingCount: $loadingCount)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, appExceptionWrapper, isLoading, loadingCount);
...
abstract class _CommonState implements CommonState {
  const factory _CommonState(
      {final AppExceptionWrapper? appExceptionWrapper,
      final bool isLoading,
      final int loadingCount}) = _$CommonStateImpl;
