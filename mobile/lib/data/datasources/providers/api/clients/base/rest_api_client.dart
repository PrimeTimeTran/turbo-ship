...
class RestApiClient {
  RestApiClient({
    ...
    this.defaultSuccessResponseMapperType = ApiClientSettings.defaultSuccessResponseMapperType,
    this.defaultErrorResponseMapperType = ApiClientSettings.defaultErrorResponseMapperType,
  ...
  Future<T> request<T, D>({
    ...
    assert(
      method != RestMethod.get ||
          (successResponseMapperType ?? defaultSuccessResponseMapperType) == SuccessResponseMapperType.plain ||
          decoder != null,
