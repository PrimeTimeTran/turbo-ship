...
const props = defineProps(['focusedAttribute', 'entity', 'focusAttr'])

const attribute = ref(props.focusedAttribute)
...
-->
<template>
  <div class="px-2 bg-white rounded min-h-full shadow-md pb-2 mt-2">
          ...
          <div class="col-span-5 flex flex-grow flex-col">
            <table class="overflow-auto scrollbar-hide w-100">
              ...
              <tbody class="overflow-auto scrollbar-hide">
                <tr
                  v-for="val of attribute.validators"
