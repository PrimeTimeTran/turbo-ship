...
<template>
  <div class="flex justify-center relative -bottom-3 left-1 right-1">
    <ul class="inline-flex -space-x-px">
      <li>
        <a
          class="bg-white border border-gray-300 text-gray-500 hover:bg-gray-100 hover:text-gray-700"
          :class="first"
        >
